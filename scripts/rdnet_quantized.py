...
# ------------ Replaces LayerNorm2d with BatchNorm2d ------------
...
class PatchifyStem(nn.Module):
    def __init__(self, num_input_channels, num_init_features, patch_size=4):
        ...
        self.stem = nn.Sequential(
            ...
            BatchNorm2d(num_init_features),  # <--- Changed here
        )
...
class Block(nn.Module):
    def __init__(self, in_chs, inter_chs, out_chs):
        ...
        self.layers = nn.Sequential(
            ...
            BatchNorm2d(in_chs),  # <--- Changed here
        ...
        for i in range(self.num_stages):
            ...
            if i != 0:
                ...
                if is_downsample_block[i]:
                    curr_stride *= 2
                    k_size = stride = 2
                dense_stage_layers.append(BatchNorm2d(num_features))  # <--- Changed here
